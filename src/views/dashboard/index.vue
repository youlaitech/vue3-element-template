...
const transitionUvCount = useTransition(
  computed(() => Number(visitOverviewData.value.todayUvCount ?? 0)),
  {
    duration: 1000,
...
const transitionTotalUvCount = useTransition(
  computed(() => Number(visitOverviewData.value.totalUvCount ?? 0)),
  {
    duration: 1200,
    transition: [0.25, 0.1, 0.25, 1.0],
  }
...
const transitionPvCount = useTransition(
  computed(() => Number(visitOverviewData.value.todayPvCount ?? 0)),
  {
    duration: 1000,
    transition: [0.25, 0.1, 0.25, 1.0],
  }
...
const transitionTotalPvCount = useTransition(
  computed(() => Number(visitOverviewData.value.totalPvCount ?? 0)),
  {
    duration: 1200,
    transition: [0.25, 0.1, 0.25, 1.0],
  }
